        ...
        <div class="main_profile_form">
          ...
          <form class="row" @submit.prevent="login">
            ...
            <div class="w-100 d-flex justify-content-center">
              <div class="col-lg-4 col-12">
                <nuxt-link class="btn_to_go_reg" :to="localePath('/auth/company/register')">
                  register as company
                </nuxt-link>
              </div>
            </div>
...
export default {
  ...
  methods: {
    async login() {
      ...
      await this.$Api.auth.companyLogin(formData).then((res) => {
    ...
    async verifyCodeFun(){
      ...
      await this.$Api.auth.companyVerifyEmailCode(formData).then((res) => {
        this.isLoading = false;
